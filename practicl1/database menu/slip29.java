...
while(flag)
{
System.out.println("Enter Student Number for the record you wish toDelete: Delete: ");
rno=Integer.parseInt(br.readLine());
...
while(rs.next())
{
System.out.println("RollNo="+rs.getInt(1)+""+"name="+rs.getString(2)+""+"3));"+"per="+rs.getInt(3));
}
break;
case 6:
System.exit(0);
